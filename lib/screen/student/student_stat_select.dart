import 'package:cloud/screen/student/stat_student_quiz_list.dart';
...
class stats_page_std extends StatefulWidget {
  const stats_page_std({Key? key}) : super(key: key);

  @override
  State<stats_page_std> createState() => stats_page_stdState();
}

class stats_page_stdState extends State<stats_page_std> {
                                  ...
                                  child:Row(
                                    children: [
                                      ...
                                      IconButton(onPressed: ()async{
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>quizlist_stat_std(id: classdata[i].id,classize: classdata[i]['students'].length,)));
                                        setState(() {
