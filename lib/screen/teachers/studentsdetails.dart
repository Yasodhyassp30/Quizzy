...
class studentdetails extends StatelessWidget {
  final details,id;
  const studentdetails({Key? key,this.details,this.id}) : super(key: key);
                        ...
                        children: [
                          Expanded(child: ElevatedButton.icon(
                            onPressed: ()async{
                              ...
                              await store.collection('classrooms').doc(id).update({'students':FieldValue.arrayRemove([data['uid']])}) ;
