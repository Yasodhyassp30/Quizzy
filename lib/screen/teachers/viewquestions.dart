...
class viewquesstion extends StatefulWidget {
  final questiondetails;
  const viewquesstion({Key? key,this.questiondetails}) : super(key: key);

  @override
  State<viewquesstion> createState() => _viewquesstionState();
}

class _viewquesstionState extends State<viewquesstion> {
  @override
              ...
              child:SingleChildScrollView(
                child:  Column(
                  ...
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.all(16),
                      child: (widget.questiondetails.containsKey('pic'))?Container(
                          padding: EdgeInsets.all(16),
                          ...
                          child:Center(
                            child: InteractiveViewer(
                              ...
                              minScale: 0.5,
                              maxScale: 4,
                              child: Image.file(widget.questiondetails['pic'],fit: BoxFit.contain,),
                            ),
                          )
                      ):Container(),
                    ),
